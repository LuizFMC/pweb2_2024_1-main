    ...
    <tbody>
        <?php $__currentLoopData = $dados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
                ...
                <td><a href="<?php echo e(route('dieta.edit', $item->id)); ?> "class="btn btn-outline-primary" title="Editar"><i
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\pweb2_2024_1-main\resources\views/dieta/list.blade.php ENDPATH**/ ?>