...
<form action="<?php echo e($route); ?>" method="post">
    ...
    <input type="text" name="almoco" class="form-control"
        value="<?php if(!empty($dado->almoco)): ?> <?php echo e($dado->almoco); ?><?php elseif(!empty(old('almoco'))): ?><?php echo e(old('almoco')); ?><?php else: ?><?php echo e(''); ?> <?php endif; ?>"><br>
...
<?php echo $__env->make('base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\pweb2_2024_1-main\resources\views/dieta/form.blade.php ENDPATH**/ ?>